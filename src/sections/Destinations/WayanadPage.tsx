  ...
  return (
    <>
      ...
      <section className="relative h-[85vh] min-h-[600px] overflow-hidden">
        ...
        <div className="absolute inset-0 bg-gradient-to-r from-[#1a1914]/50 to-transparent" />
        ...
        <div className="max-w-6xl mx-auto">
          <motion.div variants={fadeUp} initial="hidden" whileInView="visible" viewport={{ once: true }} custom={0} className="text-center mb-16">
            ...
            <p className="text-sm text-[#a09383] mt-4 max-w-xl mx-auto">
              Discover what makes this destination special and why travelers from around the world choose to explore Wayanad.
            </p>
          ...
          {visibleAttractions < attractions.length && (
            <div className="text-center mt-10">
              <button
                ...
                aria-label="View all tourist attractions in Wayanad"
              >
          ...
          >
            ...
            <div>
              ...
              <p className="text-xs text-[#7a705e] leading-relaxed">
                Wayanad's rugged landscape means its beauty shifts entirely by the calendar. October through February marks the highest traffic as the weather is cool and dry. However, monsoon season (July to September) transforms Wayanad into an incredible, damp, violently green paradise — an absolute favorite for photographers and romantic getaways.
              </p>
            </div>
          </motion.div>
        </div>
      ...
      <section className="relative py-24 md:py-32 overflow-hidden">
        <Image
          ...
          className="object-cover"
        />
        <div className="absolute inset-0 bg-[#1a1914]/60" />
        <div className="relative max-w-3xl mx-auto text-center px-6">
          <motion.div variants={fadeUp} initial="hidden" whileInView="visible" viewport={{ once: true }} custom={0}>
            ...
            <p className="text-sm text-white/60 mb-8 max-w-lg mx-auto">
              Browse our curated tour packages and start planning your unforgettable journey deep into the hills of Kerala today.
            </p>
            <Link
              href="/reserve"
