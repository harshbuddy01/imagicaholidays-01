...
const TRENDING_COLLECTION = [
  {
    ...
    title: "Sikkim",
    tagline: "Alpine lakes, monasteries, and Kanchenjunga heights.",
  ...
  },
  {
    ...
    title: "Andaman",
    tagline: "Turquoise coral lagoons and pristine white sand beaches.",
  ...
  },
  {
    ...
    title: "Udaipur",
    tagline: "Golden sunsets over legendary lakefront palaces.",
